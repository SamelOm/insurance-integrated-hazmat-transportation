"""Run the blocked 3-by-3 factorial experiment for rerouted flow."""
import itertools
...
df.to_csv(OUTPUT_DIR / "factorial_rerouting_results.csv", index=False)
...
anova_table.to_csv(OUTPUT_DIR / "factorial_rerouting_anova.csv")
